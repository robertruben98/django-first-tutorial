...
SECRET_KEY = 'django-insecure-yi#ppt(f&5qfqvh8(eck$jc(m6iqsumumgy*-zb#y+@h(^n2cd'
...
# para que un usuario solo tenga acceso a mis apis despues de haberse logeado
# REST_FRAMEWORK = {
...
REST_FRAMEWORK = {
    ...
    # hace el filtro por el tipo de usuario
...
SIMPLE_JWT = {
    ...
    # esto es solo para le modo desarrollo
